...
import { handleGoogleSignIn, handleFacebookSignIn } from "./useAuth";
    ...
    return (
        <div className="sign-up">
            <div className="container">
                ...
                {/* Google sign in */}
                <button onClick={googleSignIn} className="btn btn-danger btn-block google-sign-in" type="submit">Sign In with Google</button>

                {/* Facebook sign in */}
                <button onClick={fbSignIn} className="btn btn-danger btn-block google-sign-in" type="submit">Sign In with Facebook</button>
            </div>
